...
import 'package:mile_locally/model/order.dart';
...
class SoldProductListView extends StatefulWidget {
  const SoldProductListView({Key? key}) : super(key: key);
            ...
            return Padding(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final orderDate = DateTime.fromMillisecondsSinceEpoch(order.orderDate!);
                  final formattedDate = DateFormat('MMMM dd, yyyy').format(orderDate);
                  final formattedTime = DateFormat.jm().format(orderDate);
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            IconButton(
                                              onPressed: () {
                                                showDeleteDialog(order.orderId, context);
                                              },
                                              icon: Icon(
                                                Icons.delete,
                                                color: Colors.red,
                                        ...
                                        SizedBox(height: 5),
                                        _buildDetailText('Category', order.product?.selectedCategory),
                                        SizedBox(height: 5),
                                        _buildDetailText('Price', '${order.totalPrice}'),
                                        SizedBox(height: 5),
                                      ],
                                    ),
                                  ),
                            ...
                            _buildDetailText('Order Date', '$formattedTime, $formattedDate'),
                            _buildDetailText('Payment Id', order.paymentId),
                            _buildDetailText('Buyer Name', order.buyerName),
                            _buildDetailText('Buyer No.', order.buyerNo),
                            _buildDetailText('Buyer Email', order.userEmailId),
                            _buildDetailText('Shipping Address', order.shippingAddress),
                          ],
                        ),
                      ),
                    ),
